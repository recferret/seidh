...
var engine_base_BaseObjectEntity = function(struct) {
	this.x = struct.x;
	this.y = struct.y;
...
engine_base_BaseObjectEntity.prototype = {
	toJson: function() {
...
var engine_base_core_BaseEngine = $hx_exports["engine"]["base"]["core"]["BaseEngine"] = function(engineMode,mainEntityManager) {
...
engine_base_core_BaseEngine.prototype = {
	...
	,updateEntitiesByServer: function(minEntities) {
		var _g = 0;
		while(_g < minEntities.length) {
			var minEntity = minEntities[_g];
			++_g;
			var entity = this.mainEntityManager.entities.get(minEntity.id);
			if(entity != null) {
	...
	,setEntityNextActionToPerform: function(entityId,entityActionType) {
...
var engine_base_entity_BaseEntityManager = function() {
...
var engine_base_entity_EngineBaseGameEntity = function(baseObjectEntity) {
	...
	this.isPlayer = [1,2].indexOf(this.baseObjectEntity.entityType) != -1;
	...
	var _g = 0;
	var _g1 = this.baseObjectEntity.actions;
	while(_g < _g1.length) {
		var action = _g1[_g];
		++_g;
...
engine_base_entity_EngineBaseGameEntity.prototype = {
	update: function(dt) {
	...
	,getBodyRectangle: function() {
		var shapeWidth = this.baseObjectEntity.entityShape.width;
		var shapeHeight = this.baseObjectEntity.entityShape.height;
		var rectOffsetX = this.baseObjectEntity.entityShape.rectOffsetX;
		var rectOffsetY = this.baseObjectEntity.entityShape.rectOffsetY;
	...
	,getMinEntity: function() {
		var minEntity = { id : this.baseObjectEntity.id, x : this.baseObjectEntity.x, y : this.baseObjectEntity.y, side : this.currentDirectionSide};
		return minEntity;
	}
	,getX: function() {
...
var engine_holy_HolyGameEngine = $hx_exports["engine"]["holy"]["HolyGameEngine"] = function(engineMode) {
	if(engineMode == null) {
		engineMode = engine_base_core_EngineMode.Server;
	}
	this.timePassed = 0.0;
	this.framesPassed = 0;
	engine_base_core_BaseEngine.call(this,engineMode,new engine_holy_entity_manager_HolyEntityManager());
};
engine_holy_HolyGameEngine.__name__ = true;
engine_holy_HolyGameEngine.main = function() {
};
engine_holy_HolyGameEngine.__super__ = engine_base_core_BaseEngine;
engine_holy_HolyGameEngine.prototype = $extend(engine_base_core_BaseEngine.prototype,{
	buildEngineEntityFromMinimalStruct: function(struct) {
	...
	,processInputCommands: function(playerInputCommands) {
		...
		while(_g < playerInputCommands.length) {
			...
			var entity = js_Boot.__cast(this.mainEntityManager.getEntityById(entityId) , engine_holy_entity_base_HolyBaseEntity);
...
var engine_holy_entity_base_HolyBaseEntity = function(baseObjectEntity) {
	engine_base_entity_EngineBaseGameEntity.call(this,baseObjectEntity);
};
...
var engine_holy_entity_factory_HolyEntityFactory = function() { };
engine_holy_entity_factory_HolyEntityFactory.__name__ = true;
engine_holy_entity_factory_HolyEntityFactory.InitiateEntity = function(id,ownerId,x,y,entityType) {
	var entity = null;
	switch(entityType) {
	case 1:
...
var engine_holy_entity_impl_HolyKnightEntity = function(baseObjectEntity) {
	engine_holy_entity_base_HolyBaseEntity.call(this,baseObjectEntity);
};
engine_holy_entity_impl_HolyKnightEntity.__name__ = true;
engine_holy_entity_impl_HolyKnightEntity.GenerateObjectEntity = function(id,ownerId,x,y) {
...
engine_holy_entity_impl_HolyKnightEntity.GetMovementStruct = function() {
...
engine_holy_entity_impl_HolyKnightEntity.GetActionsStruct = function() {
	var actions = [];
...
engine_holy_entity_impl_HolyKnightEntity.prototype = $extend(engine_holy_entity_base_HolyBaseEntity.prototype,{
	__class__: engine_holy_entity_impl_HolyKnightEntity
});
var engine_holy_entity_impl_HolySamuraiEntity = function(baseObjectEntity) {
	engine_holy_entity_base_HolyBaseEntity.call(this,baseObjectEntity);
};
engine_holy_entity_impl_HolySamuraiEntity.__name__ = true;
engine_holy_entity_impl_HolySamuraiEntity.GenerateObjectEntity = function(id,ownerId,x,y) {
...
engine_holy_entity_impl_HolySamuraiEntity.GetMovementStruct = function() {
...
engine_holy_entity_impl_HolySamuraiEntity.GetActionsStruct = function() {
	var actions = [];
...
engine_holy_entity_impl_HolySamuraiEntity.prototype = $extend(engine_holy_entity_base_HolyBaseEntity.prototype,{
	__class__: engine_holy_entity_impl_HolySamuraiEntity
});
var engine_holy_entity_impl_HolySkeletonArcherEntity = function(baseObjectEntity) {
	engine_holy_entity_base_HolyBaseEntity.call(this,baseObjectEntity);
};
engine_holy_entity_impl_HolySkeletonArcherEntity.__name__ = true;
engine_holy_entity_impl_HolySkeletonArcherEntity.GenerateObjectEntity = function(id,ownerId,x,y) {
...
engine_holy_entity_impl_HolySkeletonArcherEntity.GetMovementStruct = function() {
...
engine_holy_entity_impl_HolySkeletonArcherEntity.GetActionsStruct = function() {
	var actions = [];
	actions.push({ actionType : 1, damage : 10, aoe : true, penetration : false, shape : new engine_base_EntityShape(100,100), inputDelay : 1});
	actions.push({ actionType : 2, damage : 10, aoe : true, penetration : false, shape : new engine_base_EntityShape(100,100), inputDelay : 1});
	actions.push({ actionType : 3, damage : 10, aoe : true, penetration : false, shape : new engine_base_EntityShape(100,100), inputDelay : 1});
...
engine_holy_entity_impl_HolySkeletonArcherEntity.prototype = $extend(engine_holy_entity_base_HolyBaseEntity.prototype,{
	__class__: engine_holy_entity_impl_HolySkeletonArcherEntity
});
var engine_holy_entity_impl_HolySkeletonWarriorEntity = function(baseObjectEntity) {
	engine_holy_entity_base_HolyBaseEntity.call(this,baseObjectEntity);
};
engine_holy_entity_impl_HolySkeletonWarriorEntity.__name__ = true;
engine_holy_entity_impl_HolySkeletonWarriorEntity.GenerateObjectEntity = function(id,ownerId,x,y) {
...
engine_holy_entity_impl_HolySkeletonWarriorEntity.GetMovementStruct = function() {
...
engine_holy_entity_impl_HolySkeletonWarriorEntity.GetActionsStruct = function() {
	var actions = [];
...
engine_holy_entity_impl_HolySkeletonWarriorEntity.prototype = $extend(engine_holy_entity_base_HolyBaseEntity.prototype,{
	__class__: engine_holy_entity_impl_HolySkeletonWarriorEntity
});
var engine_holy_entity_manager_HolyEntityManager = function() {
	engine_base_entity_BaseEntityManager.call(this);
};
...
engine_holy_entity_manager_HolyEntityManager.prototype = $extend(engine_base_entity_BaseEntityManager.prototype,{
