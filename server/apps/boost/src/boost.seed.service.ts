import { Boost, BoostDocument, BoostType, CurrencyType } from "@app/seidh-common/schemas/boost/schema.boost";
import { Injectable, OnModuleInit } from "@nestjs/common";
import { InjectModel } from "@nestjs/mongoose";
import { Model } from "mongoose";

@Injectable()
export class BoostSeedService implements OnModuleInit {
